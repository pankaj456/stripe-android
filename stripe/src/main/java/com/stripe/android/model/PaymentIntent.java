...
public class PaymentIntent extends StripeJsonModel {
    ...
    static final String FIELD_SHIPPING = "shipping";
    ...
    public Uri getAuthorizationUrl() {
        if (mStatus.equals("requires_source_action") &&
                mNextSourceAction.containsKey("type") &&
                mNextSourceAction.get("type").equals("authorize_with_url") &&
                mNextSourceAction.containsKey("value") && mNextSourceAction.get("value") instanceof Map) {
            Map<String, String> urlMap = (Map) mNextSourceAction.get("value");
            if (urlMap.containsKey("url")) {
                return Uri.parse(urlMap.get("url"));
            }
        }
        return null;
    }
    ...
    public static PaymentIntent fromJson(@Nullable JSONObject jsonObject) {
        ...
        String shippingString = optString(jsonObject, FIELD_SHIPPING);
        ShippingMethod shippingMethod = null;
        if (shippingString != null) {
            shippingMethod = ShippingMethod.fromString(shippingString);
        }
    ...
    public JSONObject toJson() {
        ...
        putArrayIfNotNull(jsonObject, FIELD_ALLOWED_SOURCE_TYPES, listToJsonArray(mAllowedSourceTypes));
        ...
        putStripeJsonModelIfNotNull(jsonObject, FIELD_SHIPPING, mShippingMethod);
    ...
    public Map<String, Object> toMap() {
        ...
        StripeJsonModel.putStripeJsonModelMapIfNotNull(map, FIELD_STATUS, mShippingMethod);
